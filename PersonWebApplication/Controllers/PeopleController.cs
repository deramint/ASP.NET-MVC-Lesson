...
using PersonWebApplication.Data;
...
namespace PersonWebApplication.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,PerfectureId,Hireate,IsAttendance,Email,Blog,EmployeeNo")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,PerfectureId,Hireate,IsAttendance,Email,Blog,EmployeeNo")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
